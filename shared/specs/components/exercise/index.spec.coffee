...
describe 'Exercise Component', ->
  ...
  xit 'attempts next step if correct answer and feedback are not available after multiple-choice submit', ->
  ...
  xit 'updates free response when passed new ones', ->
    step.free_response = 'hi hi'
  ...
  # setProps is now gone, need to find replacement
  xit 'updates chosen answer when passed in updates', ->
    step.answer_id = CHOICES[0].id
