...
describe 'Exercise Helper', ->
  ...
  it 'calculates trouble url', ->
    expect(Exercise.troubleUrl({
      ...
      project: 'tutor',
      exerciseId: '22@22'
    })).toEqual('https://oscms-dev.openstax.org/errata/form?source=tutor&location=22%4022&book=Biology')

  it 'skips missing parts', ->
    expect(Exercise.troubleUrl({
      exerciseId: '42@1'
    })).toEqual('https://oscms-dev.openstax.org/errata/form?location=42%401')
