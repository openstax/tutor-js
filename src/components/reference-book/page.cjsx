...
EXERCISE_LINK_SELECTOR = '.os-exercise .autogenerated-content'
...
module.exports = React.createClass
  ...
  renderExercises: ->
    root = @getDOMNode()
    exercises = root.querySelectorAll(EXERCISE_LINK_SELECTOR)
    ReferenceBookExerciseStore.setMaxListeners(exercises.length)
