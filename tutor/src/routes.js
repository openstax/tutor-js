      ...
      renderer: r(() => import('./screens/qa-view'), 'QA View') },
    {
      ...
      routes: [
        ...
        { path: 'reading/:id', name: 'editReading',
          renderer: r(() => import('./screens/assignment-builder/reading'), 'Reading') },
        { path: 'external/:id', name: 'editExternal',
          renderer: r(() => import('./screens/assignment-builder/external'), 'External') },
        { path: 'event/:id', name: 'editEvent',
          renderer: r(() => import('./screens/assignment-builder/event'), 'Event') },
