        ...
        <Cell>
            <CellContents>
                ...
                <ColumnHeading>
                    ...
                    >
                        Total <SortIcon sort={ux.sortForColumn('course_average', 'score')} />
                    </HeadingTop>
                    <HeadingMiddle>
                ...
                <ColumnHeading>
                    <HeadingTop>
                        Averages <Icon type="info-circle" className="info-circle-icon-button" onClick={() => ux.showAverageInfo()} />
                    </HeadingTop>
                    <HeadingMiddle>
                        <SplitCell
                            border
                        ...
                        >
                            Homework <SortIcon sort={ux.sortForColumn('homework_score', 'score')} />
                        </SplitCell>
                        <SplitCell
                            onClick={() => ux.changeRowSortingOrder('reading_score', 'score')}
                        >
                            Reading <SortIcon sort={ux.sortForColumn('reading_score', 'score')} />
                        </SplitCell>
                    </HeadingMiddle>
                    <HeadingBottom>
                        <SplitCell border>
