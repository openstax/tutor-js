...
const OfferingList = ({ subject, offerings }) => {
...
const SubjectDetail = ({ offerings, selectedSubject, history, setActiveScreen }) => {
    ...
    <StyledPage>
      ...
      <SubjectWrapper>
        ...
        <Block variant="light" className="text">
          ...
          <TutorLink className="btn btn-light" to="createNewCourse">Create a course</TutorLink>
        </Block>
      </SubjectWrapper>
    </StyledPage>
  )
...
const SubjectSuggested = ({ setActiveScreen }) => {
  return (
    <StyledPage>
      ...
      <Wrapper>
        <TwoCol className="narrow">
          <Block variant="light" className="text action-card">
            ...
            <Button variant="primary" onClick={() => setActiveScreen(Screens.Select)}>Continue to OpenStax Tutor</Button>
          </Block>
          <Block variant="light" className="text action-card">
            ...
            <a className="btn btn-light" href={CourseInformation.openstaxSubjects}>
...
const NewUser = ({ history, windowImpl = window }) => {
