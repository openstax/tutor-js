        ...
        return (
            <div className="student-access direct-links-only">
                <p>
                    ...
                    integration? <a target="_blank" className="external-icon" href="https://help.openstax.org/s/article/LMS-integration-for-OpenStax-Tutor-Beta">Find out more.</a>
                </p>
                <p>
    ...
    render() {
        ...
        return (
            <div className="student-access">
                ...
                <a href="https://help.openstax.org/s/article/Student-Access-with-Enrollment-Link-versus-LMS-sign-in-for-OpenStax-Tutor-Beta-LMS-Pilots" target="_blank">
