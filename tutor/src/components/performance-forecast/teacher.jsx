...
export default class PerformanceForecastTeacherDisplay extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      periodId: __guard__(first(periods), x => x.period_id),
    };
  }

  selectPeriod = (period) => this.setState({
    periodId: period.id,
  });
    ...
    <div>
      <div className='guide-heading'>
        ...
        <div className='info'>
          ...
          <BackButton fallbackLink={{ to: 'dashboard', text: 'Back to Dashboard', params: Router.currentParams() }} />
        </div>
      </div>
      <CoursePeriodsNav
  ...
  renderEmptyMessage = () => (
    <div className="no-data-message">
      There have been no questions worked for this <CourseGroupingLabel courseId={this.props.courseId} lowercase={true} />.
    </div>
  );
  ...
  renderWeakerExplanation = () => (
    <div className='explanation'>
      <p>
        Tutor shows the weakest topics for each <CourseGroupingLabel courseId={this.props.courseId} lowercase={true} />.
      </p>
      <p>
