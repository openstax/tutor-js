...
const Troubleshoot = () => (
    <NewTabLink
        href="https://help.openstax.org/s/article/How-do-I-send-student-scores-from-OpenStax-Tutor-to-my-learning-management-system"
    >
    ...
    >
      ...
      If this problem persists, you may need to perform extra steps in your LMS. This support article shows you how:
        ...
        <div>
            <p>
                <NewTabLink
                    to="https://help.openstax.org/s/article/How-do-I-send-student-scores-from-OpenStax-Tutor-to-my-learning-management-system"
                >
