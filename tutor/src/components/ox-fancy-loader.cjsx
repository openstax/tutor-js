    ...
    <div className='ox-loader'>
      ...
      <div className="ox-loader--inner">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 -25 57.6 66" enableBackground="new 0 -25 57.6 66">
          ...
          <path id="ox-yellow" className="ox-yellow" fill="#F4D019" d="M41.8,17.8c0,0.4-0.3,0.7-0.7,0.7l-25.4,0.8c-0.4,0-0.7-0.3-0.7-0.7l-0.1-2.1
            c0-0.4,0.3-0.7,0.7-0.7L41,15c0.4,0,0.7,0.3,0.7,0.7L41.8,17.8z"/>
          <path id="ox-gray" className="ox-gray" fill="#5E6062" d="M34.8,14c0,0.4-0.3,0.7-0.7,0.7H11.6c-0.4,0-0.7-0.3-0.7-0.7v-3.5c0-0.4,0.3-0.7,0.7-0.7h22.5
            c0.4,0,0.7,0.3,0.7,0.7V14z"/>
          <path id="ox-orange" className="ox-orange" fill="#F47641" d="M39,8.1c0,0.3-0.4,0.5-1,0.5H8.6c-0.5,0-1-0.2-1-0.5V6.9c0-0.3,0.4-0.5,1-0.5H38
            c0.5,0,1,0.2,1,0.5V8.1z"/>
          <path id="ox-green" className="ox-green" fill="#77AF42" d="M43.9,5c0,0.7-0.6,1.2-1.2,1.1L15,4.8c-0.7,0-1.2-0.6-1.1-1.2L14,1.1c0-0.7,0.6-1.2,1.2-1.1
            l27.7,1.3c0.7,0,1.2,0.6,1.1,1.2L43.9,5z"/>
          <path id="ox-type" className="st2" fill="#5E6062" d="M3.1,30.2c-1.8,0-3.1,1.3-3.1,3.1c0,1.8,1.3,3.1,3.1,3.1c1.8,0,3.1-1.3,3.1-3.1
